...
$ns simplex-link $n1 $n2 10Mbps 60ms MYPID             ;#链路瓶颈的设置及处理算法，MYPID既是模糊自适应MYPID算法
$ns simplex-link $n2 $n1 10Mbps 60ms MYPID    

#Configure MYPID queue parameters here
set mypidq [[$ns link $n1 $n2] queue]
