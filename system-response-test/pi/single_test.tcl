...
$ns simplex-link $n1 $n2 10Mbps 60ms PI             ;#链路瓶颈的设置及处理算法，PI既是模糊自适应PI算法
$ns simplex-link $n2 $n1 10Mbps 60ms PI    

#Configure PI queue parameters here
set piq [[$ns link $n1 $n2] queue]
set tchan_ [open all.q w]
$piq trace curq_
$piq attach $tchan_
$piq set w_ 170
$piq set qref_ 300                                ;#期望队列长度
$piq set a_ 0.0005                               ;#期望队列长度
$piq set b_ 0.0005                                ;#期望队列长度
